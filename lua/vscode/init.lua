-- author: gamunu
-- date: 2023-03-01
-- repo: https://github.com/gamunu/vscode

-- An interesting neovim colors scheme plugin ..

local core = require("vscode.core")
local utils = require("vscode.utils")
local hooks = require("vscode.core.hooks")

local default_colors = require("vscode.colors")
local default_config = require("vscode.config")
...
function M.get_lualine_sections()
    return require("vscode.extra.lualine.sections")(
        M.get_config(),
        M.get_colors()
    )
end
...
function M.get_bufferline_right()
    return require("vscode.extra.bufferline.right")(
        M.get_config(),
        M.get_colors()
    )
end
